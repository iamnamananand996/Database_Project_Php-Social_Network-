...
{
 $query = "
 SELECT user_content_like.user_id, comments.description, user_details.user_name, user_details.user_image FROM user_content_like
 INNER JOIN comments 
  ON comments.content_id = user_content_like.content_id 
