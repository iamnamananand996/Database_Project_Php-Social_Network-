...
<html>
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
        ...
        <!-- <div class="container"> -->
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <!-- <li class="about"><a href="#"><span class="glyphicon glyphicon-info-sign"></span><h5>ABOUT</h5></a></li> -->
   ...
   <h3 align="center">SOCIAL NETWORK</a></h3><br />
   <br />
   <div class="row">
    ...
    <div class="col-md-2 col-sm-3">
     <p align="right">Hi - <?php echo $_SESSION['user_name']; ?> - <a href="logout.php">Logout</a></p>
    </div>
   </div>
...
$(document).ready(function(){
 ...
 function make_chat_dialog_box(to_user_id, to_user_name)
 {
  ...
  modal_content+= '<button type="button" name="send_chat" id="'+to_user_id+'" class="btn btn-info send_chat" style="background-color: #25CCF7">Send</button></div></div>';
